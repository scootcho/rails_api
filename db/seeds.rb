Company.delete_all
buyer = Company.create(name: "cannabuyer", email: "buyer.com", address: "in the clouds", city: "SF", state: "CA", zipcode: "94132")
seller = Company.create(name: "cannaseller", email: "seller.com", address: "Hamboldtbuddy", city: "Hamboldt", state: "CA", zipcode: "95002")
